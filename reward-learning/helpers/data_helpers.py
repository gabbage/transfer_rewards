...
from scorer.data_helper.json_reader import readArticles, readScores, readArticleRefs
...
def sent2tokens_wostop(sent, stoplist, language, lower=True):
    """
...
def sent2stokens_wostop(sent, stemmer, stoplist, language, lower=True):
    """
...
def calculate_oov_stats():
    ...
    json.dump(oov_tokens_counter, open("oov_tokens.json", "w"))
