...
rsync_cmd = "rsync --inplace -a --progress buecker@130.83.167.142:transfer_rewards/sub_rewards/live_data.csv live_server.csv"
...
def animate(i):
    ...
    ax1.set_xlabel('#batches (2725 batches per epoch)')
    ax1.set_ylabel('Loss')
    ax2.set_ylabel('%')
    if only_last_batch:
